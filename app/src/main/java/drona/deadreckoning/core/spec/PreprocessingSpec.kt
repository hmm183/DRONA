package drona.deadreckoning.core.spec
...
enum class ImuFrame {
     ...
     * [drona.deadreckoning.core.frame.VehicleFrameTransform], but no model is
...
data class PreprocessingSpec(
    ...
    companion object {
         ...
         * travelled, which
         * [drona.deadreckoning.fusion.VehicleFusionEkf.predictVelocity] avoids.
         */
