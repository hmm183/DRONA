package drona.deadreckoning.activity;
...
import drona.deadreckoning.R;
import drona.deadreckoning.model.Marker;
import drona.deadreckoning.preferences.TurnModePreferences;
import drona.deadreckoning.preferences.StepCounterPreferences;
import drona.deadreckoning.sensor.DeadReckoningEngine;
import drona.deadreckoning.sensor.PreciseHeadingEstimator;
import drona.deadreckoning.storage.MarkerStorage;
import drona.deadreckoning.storage.TripStorage;
import drona.deadreckoning.view.DegreeDialView;
...
public class MapFragment extends Fragment implements SensorEventListener {
    ...
    private void initMap(View view) {
        ...
        drona.deadreckoning.util.IndiaBoundaryOverlayHelper.applyOfficialBoundary(requireContext(), mapView);
